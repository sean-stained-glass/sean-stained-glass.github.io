...
const tissueBoxPriorityBackgrounds = [
  {
    id: "tissue-scandi-solid-wood-dining",
    name: "自然实木餐桌",
    group: "surface",
    temperature: "warm",
    brightness: "bright",
    contrast: "soft",
    description:
      "浅色天然实木餐桌，桌面铺米白或燕麦色纯棉桌布，旁边有粗陶杯、简单餐具和一把弧背木椅，背景是暖白墙与低对比木质边柜，空间像安静的家庭餐区。",
    light:
      "柔和晨光或午后侧光从窗外照入，木纹清楚但不过曝，纸巾盒、木框和桌面阴影保持中性灰黑。",
    sourceUrl: "https://www.pinterest.com/pin/1137370080942108835/",
  },
  {
    id: "tissue-organic-round-dining",
    name: "有机弧形木餐区",
    group: "surface",
    temperature: "neutral",
    brightness: "bright",
    contrast: "soft",
    description:
      "浅灰米墙面、圆角实木餐桌和弧形木椅组成现代有机餐区，桌面只放陶瓷器皿、干枝或一只低矮花器，线条柔和克制。",
    light:
      "大面积侧窗漫射光，背景明暗过渡柔和，材质纹理真实，纸巾盒周围没有强反光或彩色光斑。",
    sourceUrl: "https://www.pinterest.com/pin/1137370080942108829/",
  },
  {
    id: "tissue-wildflower-table-runner",
    name: "野花桌旗餐区",
    group: "surface",
    temperature: "warm",
    brightness: "bright",
    contrast: "medium",
    description:
      "米白餐桌铺彩色野花绗缝桌旗，配浅木椅、单支小花和乡村风陶瓷餐具，背景干净，花园色彩只出现在桌旗和少量花材上。",
    light:
      "明亮自然光从侧前方照入，桌旗颜色清楚但背景降饱和，纸巾盒的中性阴影保持干净。",
    sourceUrl: "https://www.pinterest.com/pin/1137370080942108823/",
  },
  {
    id: "tissue-compact-apartment-nook",
    name: "小户型餐边角",
    group: "interior",
    temperature: "warm",
    brightness: "medium",
    contrast: "soft",
    description:
      "紧凑的小户型餐角，实木餐桌、长凳或窄椅、米灰墙、边柜和小型陶瓷花器，空间整洁克制，保留真实居家尺度。",
    light:
      "窗侧自然光形成柔和方向，桌面和墙面浅色，纸巾盒产生中性灰接触阴影。",
    sourceUrl: "https://www.pinterest.com/pin/1137370080942108821/",
  },
  {
    id: "tissue-blonde-wood-brunch",
    name: "浅木色早午餐",
    group: "surface",
    temperature: "warm",
    brightness: "bright",
    contrast: "soft",
    description:
      "浅金色实木长餐桌，亚麻餐巾、可颂、水果、橙汁和简洁茶杯组成早午餐场景，背景为明亮餐厅与浅色椅子。",
    light:
      "上午明亮柔光，暖白基调，食物和木材颜色自然，纸巾盒不出现彩色反光。",
    sourceUrl: "https://www.pinterest.com/pin/1137370080942108807/",
  },
  {
    id: "tissue-sculptural-pedestal-table",
    name: "雕塑感圆桌",
    group: "surface",
    temperature: "neutral",
    brightness: "medium",
    contrast: "medium",
    description:
      "雕塑感圆柱底座的圆桌置于米色现代空间，木质、石材和米灰墙面形成有机建筑感，桌面只保留一件陶瓷或干枝道具。",
    light:
      "大窗柔和侧光，背景低对比，桌面材质有真实颗粒，纸巾盒阴影为中性灰。",
    sourceUrl: "https://www.pinterest.com/pin/1137370080942108794/",
  },
  {
    id: "tissue-marble-flute-dining",
    name: "白大理石豪华餐桌",
    group: "surface",
    temperature: "neutral",
    brightness: "bright",
    contrast: "medium",
    description:
      "白色大理石纹理椭圆餐桌搭配胡桃木凹槽底座，少量黄铜细节，背景是简洁豪华餐厅和低对比软装。",
    light:
      "明亮侧光照清大理石纹理，阴影中性，不能出现石材彩色反光或玻璃彩色投影。",
    sourceUrl: "https://www.pinterest.com/pin/1137370080942108808/",
  },
  {
    id: "tissue-live-edge-walnut-table",
    name: "活边胡桃木餐桌",
    group: "surface",
    temperature: "warm",
    brightness: "medium",
    contrast: "medium",
    description:
      "活边胡桃木餐桌配简洁金属桌脚，自然木纹、陶器、植物和少量手工家具构成温暖现代空间。",
    light:
      "暖色侧光照亮木纹，背景处于低对比虚化中，纸巾盒阴影保持中性深木棕或炭灰。",
    sourceUrl: "https://www.pinterest.com/pin/1137370080942108790/",
  },
  {
    id: "tissue-japandi-beige-bathroom",
    name: "Japandi 米色浴室",
    group: "interior",
    temperature: "warm",
    brightness: "bright",
    contrast: "soft",
    description:
      "Japandi 米色浴室，浅洞石或微水泥墙面、木柜、亚麻织物和陶瓷洗盆，留白充足，整体安静柔和。",
    light:
      "窗边漫射光，墙面没有硬阴影，纸巾盒和木框产生中性灰黑接触阴影。",
    sourceUrl: "https://www.pinterest.com/pin/1137370080942184952/",
  },
  {
    id: "tissue-moroccan-ceramic-basin",
    name: "摩洛哥陶瓷台盆",
    group: "surface",
    temperature: "warm",
    brightness: "medium",
    contrast: "medium",
    description:
      "米色手工陶瓷圆形台上盆，表面有低调手绘图案，石质台面、拱形墙洞或暖灰墙形成摩洛哥安静质感。",
    light:
      "侧上方柔光照亮陶器纹理，阴影中性温暖，纸巾盒不接触陶瓷色。",
    sourceUrl: "https://www.pinterest.com/pin/1137370080942184995/",
  },
  {
    id: "tissue-live-edge-vanity",
    name: "活边原木浴室台面",
    group: "surface",
    temperature: "warm",
    brightness: "medium",
    contrast: "medium",
    description:
      "活边实木浴室搁板或洗手台，原木纹理、白墙、陶瓷器皿和少量绿植组成现代 rustic 空间，木质边缘自然但台面平整。",
    light:
      "侧窗漫射光照清木材纹理，背景白墙低对比，纸巾盒产生中性灰黑阴影。",
    sourceUrl: "https://www.pinterest.com/pin/1137370080942184791/",
  },
  {
    id: "tissue-stone-onyx-travertine-bathroom",
    name: "洞石与玉石浴室",
    group: "surface",
    temperature: "neutral",
    brightness: "bright",
    contrast: "medium",
    description:
      "洞石、白玉石或卡拉拉大理石手工台盆的极简豪华浴室，石材纹理、圆润边缘和低饱和背景形成自然奢华感。",
    light:
      "侧后方柔光让石材颗粒清楚，保持低饱和中性阴影，禁止彩色焦散和石材彩色反光。",
    sourceUrl: "https://www.pinterest.com/pin/1137370080942184919/",
  },
];
...
const materialReplacementSubjectLockRule =
  "【纸巾盒款主体变换：图1图案、图2纸巾盒、图3可选颜色】图1是唯一图案与图像参考，只提取图1中的主体造型、图案、轮廓、象征元素和构图关系，并删除图1自己的背景、边框、无关道具和文字。图2是唯一纸巾盒本体；必须严格保留图2的外形、结构、比例、尺寸、开口、盒体轮廓、边缘、转角、接缝、材质、原有颜色基底、背景、机位、光线、阴影、桌面和其他物体。图3是可选颜色参考图，只提取图3主体的颜色搭配、色相关系、饱和度、明暗层次和主辅色比例，不复制图3的造型、图案、构图、背景或物体。只更换图2目标物体表面的装饰图案，其他内容全部保持不变。把图1图案重新适配到图2可见的正面、顶面或侧面区域，图案必须贴合目标物体原有表面边界、转角、开口和结构，不能改变物体几何形状，不能覆盖或破坏原本的功能结构。【纸巾盒比例唯一标准 22:8.5】纸巾盒宽高比固定为 22:8.5，即宽22、高8.5（约2.59:1），这是唯一标准，优先级高于图2照片中由拍摄角度造成的透视偏差。合格形态是又长又扁的低矮长条盒：正面玻璃面板是横向长条，宽度始终明显大于高度，木框上下边窄而均匀。禁止接近正方形、偏高、变窄、变厚、被拉伸、被压扁，或出现3:1、4:1这类夸张扁长的畸形比例。只要图2或生成结果里的盒体比例偏离 22:8.5，就按该标准校正盒体长宽高，同时保持顶面长条开口、玻璃嵌槽、木框厚度和桌面接触关系不变。";
...
const tissueBoxLightOnText =
  "纸巾盒里面有微弱的暖黄色光源会发光，主体色彩不变（只增加盒内微弱暖光，不改变 Etsy 实拍机位、构图和背景）。";

const tissueBoxLightOffText =
  "不开灯，纸巾盒内部没有任何光源，不出现发光、光晕、内部亮光或任何盒内光点。";

const tissueBoxLightBatchRule =
  "【纸巾盒灯光变量】七组场景中随机且固定只有两组开灯，其余五组一律不开灯。开灯组必须在提示词中写明：纸巾盒里面有微弱的暖黄色光源会发光，主体色彩不变；不开灯组必须写明盒子内部没有光源。不允许七组全部开灯或全部不开灯。本变量优先级低于前面所有 Etsy 实拍与店铺风格规则：开灯只允许增加盒内一层微弱暖黄光，不得改变 Etsy 实拍机位、景别、构图、背景内容、光线方向和中性阴影规则。";
...
function renderProductUploadMode() {
  ...
  if (!isBookend) {
    elements.productTypeHint.textContent = isMaterialReplacement
      ? "纸巾盒款：工作台上传图1图案；豆包按图1图案、图2纸巾盒、图3可选颜色放图。场景优先从新加入的纸巾盒专用背景池随机抽取。"
      : "挂链款保持现有流程，上传一张主体图即可。";
