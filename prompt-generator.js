...
const materialReplacementSubjectColorRule =
  "【通用玻璃主体变换颜色优先级】第一，如果本轮在工作台选择了色彩变量，以工作台选择的色彩搭配为主，图1和图3颜色不得覆盖所选色彩变量，只允许黑色、深灰、白色、乳白或象牙白作为轮廓和高光辅助色。第二，如果本轮没有选择工作台色彩变量且提供了图3，则以图3主体的颜色作为图案主要配色参考。第三，如果本轮没有选择工作台色彩变量且没有图3，则使用图1图案原本的色相体系和颜色分布。颜色只作用于图2目标物体表面的图案，不改变目标物体原有基底、背景、桌面、阴影或倒影颜色。";
...
function renderSubjectLibrary() {
  ...
  if (isMaterialReplacementProduct()) {
    ...
    elements.shapeVariableDescription.textContent =
      "通用玻璃主体变换锁定图2目标物体的外形、背景和结构，只用图1替换表面图案；图3仅作为可选颜色参考。";
